...
namespace RM_BBTS
{
    ...
    public class Tutorial : MonoBehaviour
    {
        ...
        public void LoadIntroTutorial()
        {
            ...
            {
                pages.Add(new Page("Welcome to the battle simulator, <b>Battle Bot</b>! I'm <b>Helper Bot</b>, and I'll be teaching you battle strategies through this simulator! But first, you should know that these strategies revolve around the concept of <b>probability</b>."));
                pages.Add(new Page("<b>Probability</b> is a math subject where you assess the likelihood of an event. In decimal form, an event with a 0.00 chance will never happen, and an event with a 1.00 chance will always happen. The higher an event's chance, the more likely it is to happen."));
                
                // Probability Percentage Page
                probPercentPage = new Page("Probability can also be expressed in <b>percentage form</b> and <b>fraction form</b>. In <b>percentage form</b>, the same rules apply, but percentages are used instead of decimals, with 0% and 100% meaning 0.00 and 1.00 respectively.");
                pages.Add(probPercentPage);

                // Probability Fraction Page (Start)
                probFractionPageStart = new Page("In <b>fraction form</b> (x/y), the denominator (y) represents the size of the whole group, while the numerator (x) represents the size of a portion of the group.");
                pages.Add(probFractionPageStart);
                ...
                pages.Add(new Page("With all that explained, welcome to the <b>overworld</b>! You need to beat the <b>boss</b> to finish the simulation, but they're behind that scary locked door! Looks like you'll have to go through a different door for now…"));

                // Hud Page
                // Hud page requires moving the textbox, so save it.
                hudPage = new Page("To the left is your <b>health</b>, to the right is your <b>energy</b>, at the bottom is your <b>score</b>, and at the top is the <b>current round number</b>, all of which I'll elaborate on later. There are also various buttons at the top, so check those out at your leisure.");
                pages.Add(hudPage);
        ...
        public void LoadBattleTutorial()
        {
            ...
            {
                pages.Add(new Page("Welcome to your first battle, <b>Battle Bot</b>! To win the battle, you must bring your opponent's health down to 0. But if the opponent brings your health down to 0, you'll get a game over! To attack your opponent, you must use your battle moves!"));
                pages.Add(new Page("You can have up to 4 <b>battle moves</b> at a time, which together with the <b>run</b> and <b>charge</b> moves makes for a total of 6 battle options! To learn a new move, you must accept a move offer, which is given out every time you clear a room."));
                pages.Add(new Page("The <b>charge move</b> is used to charge your energy, which is needed to perform your battle moves, while the <b>run move</b> has you attempt to flee from the battle."));
        ...
        public void LoadFirstMoveTutorial()
        {
            ...
            else // Default
            {
                ...
                pages.Add(new Page("A move's <b>rank</b> determines how advanced it is, a move's <b>power</b> determines how much damage it does, a move's <b>accuracy</b> determines how likely it is to hit its target, and a move's <b>energy usage</b> determines how much energy is needed to use said move."));
        ...
        public void LoadCriticalDamageTutorial()
        {
            ...
            {
                pages.Add(new Page("You have encountered <b>critical damage</b>! Critical damage multiplies the power of a move when it successfully hits its target. Unless a move's description states otherwise, every directly damaging move has the same critical damage chance."));
            }
        ...
        public void LoadRecoilDamageTutorial()
        {
            ...
            {
                pages.Add(new Page("You just encountered <b>recoil damage</b>! Some moves deal damage to the user when performed successfully. A move's description will state if it does recoil damage."));
            }
        ...
        public void LoadStatChangeTutorial()
        {
            ...
            {
                pages.Add(new Page("You have encountered a <b>stat change</b>! A battler's stats can be temporarily adjusted by certain moves, and by certain game events. These stat changes reset when the battle ends."));
            }
        ...
        public void LoadBurnTutorial()
        {
            ...
            {
                pages.Add(new Page("You have encountered <b>burn status</b>! A battler inflicted with burn status will take damage every turn. Burn status wears off when the battle ends, for both you and your opponent."));
            }
        ...
        public void LoadParalysisTutorial()
        {
            ...
            {
                pages.Add(new Page("You have encountered <b>paralysis status</b>! A battler inflicted with paralysis will move slower and has a chance of missing their turn. Once the battle ends, both you and your opponent are cured of paralysis."));
            }
        ...
        public void LoadOverworldTutorial()
        {
            ...
            {
                pages.Add(new Page("Look! The other doors have closed, but the <b>boss door</b> is still locked! I guess you'll have to clear all the other rooms before the boss accepts your challenge. Both you and your foes will get stronger as the game progresses, so good luck!"));
            }
        ...
        public void LoadTreasureTutorial()
        {
            ...
            {
                pages.Add(new Page("This is a <b>treasure room</b>! If you take the treasure, you'll get a free level up, and a chance to learn 1 of 3 moves! If you don't take the treasure, the room will remain open, so you can always come back later."));
            }
        ...
        public void LoadQuestionTutorial()
        {
            ...
            {
                pages.Add(new Page("Heads up! You're about to be asked a <b>question</b>. From this point forward, you'll get a question every time you clear a room."));
                pages.Add(new Page("If you answer <b>correctly</b>, you'll get a bonus that'll help you in the next room. But if you answer <b>incorrectly</b>, you'll get a penalty for the next room. Good luck!"));
        ...
        public void LoadPhaseTutorial()
        {
            ...
            {
                pages.Add(new Page("The <b>game phase</b> has changed! When the phase changes, you get permanent stat boosts, while the remaining enemies regain their health and energy. Enemies can also evolve from a phase change, which makes them stronger and gives them new moves. Good luck!"));
        ...
        public void LoadBossTutorial()
        {
            ...
            {
                pages.Add(new Page("Look! It's the <b>boss</b> of the simulation! Once you defeat them, the battle simulator will be complete! Good luck!"));
            }
        ...
        public void LoadGameOverTutorial()
        {
            ...
            {
                pages.Add(new Page("You got a <b>game over</b>! Your health and energy have been restored, but some of your moves have changed, and the doors have switched places. The enemies have had their health and energy restored too, but their moves haven't changed. Good luck!"));
            }
